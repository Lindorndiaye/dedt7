    ...
    <div id="wrapper">
        ...
        <div class="content-page" style="margin-left:15px; margin-top:-100px;">
            ...
            <tr>
                ...
                <td><a href="{!! $student->campus !!}" target=_blank>Ouvrir</a></td>
                <td><b>{!! $student->mobile !!}</b></td>
               <td><b>{!! $student->niveau !!}</b></td>
                <td style="text-align:center"><b>{!! $student->rendezvous !!}</b></td>
               
                <td><div class="tiles-progress">
                    <div class="m-t-20">
                    <h5 class="text-uppercase"> <span class="pull-right" style="margin-top:-25px;">{{($student->etat *100)/6}}%</span></h5>
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: {{($student->etat *100)/6}}%">
